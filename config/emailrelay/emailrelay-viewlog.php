	...
	<tr>
		<td>
			...
			<table class="tabcont" width="100%" border="0" cellspacing="0" cellpadding="0" summary="main area">
				...
				<?php
					if ($filtertext)
						dump_clog($emailrelay_logfile, $nentries, true, array("$filtertext"), array("ppp"));
					else
						dump_clog($emailrelay_logfile, $nentries, true, array(), array("ppp"));
				?>
				<tr>
